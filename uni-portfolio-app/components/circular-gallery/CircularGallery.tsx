...
class Title {
  ...
  createMesh() {
    ...
    const { Plane, Program, Mesh } = require('ogl');
...
class Media {
  ...
  createShader() {
    const { Texture, Program } = require('ogl');
...
class App {
  ...
  createScene() {
    const { Transform } = require('ogl');
    this.scene = new Transform();
  }

  createGeometry() {
    const { Plane } = require('ogl');
